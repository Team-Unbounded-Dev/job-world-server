...
import com.example.jobworldserver.user.dto.common.UserDto;
...
@Slf4j
@Tag(name = "OAuth2", description = "OAuth2 인증 및 토큰 발급 API")
@RestController
...
public class OAuth2Controller {
    ...
    @Operation(summary = "OAuth2 사용자 정보 조회", description = "OAuth2 인증된 사용자의 정보를 반환합니다.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "OAuth2 토큰 발급", description = "OAuth2 인증된 사용자에게 Access Token과 Refresh Token을 발급합니다.")
    @ApiResponses(value = {
